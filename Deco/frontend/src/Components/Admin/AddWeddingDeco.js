            ...
            <div class="dashboard-wrapper">
                <div style={{ paddingTop: '3%', paddingLeft: '2%', width: '98%' }}>
                    ...
                    <div className="container-fluid bg-white" style={{ paddingLeft: '5%', paddingTop: '2%', paddingBottom: '2%', paddingRight: '5%' }} >
                        <center>
                            <div className='card' style={{ backgroundColor: "#D0D3D4", boxShadow: "0 0 10px rgba(0, 0, 0, 0.5)", width: "90%" }}>
                                {disableBtn ? (
                                ...
                                <div class="row container-fluid" style={{ marginTop: '7%', marginBottom: '7%' }}>
                                    <form onSubmit={handleSubmit}>
                                        <div class="row mb-4">
                                            <div className="col">
                                                <TextField className="form-control" id="outlined-basic" label="Decoration ID" placeholder='D056' variant="outlined" style={{ width: "800px" }} value={code} onChange={(e) => {
                    ...
                    <center>
                        <div className='card' style={{ backgroundColor: "#FCF3CF", boxShadow: "0 0 10px rgba(0, 0, 0, 0.5)", width: "95%" }}>
